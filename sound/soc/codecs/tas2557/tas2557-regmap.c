...
/* splitting the long data transmission into several parts for avoiding potential interruption */
#define SPLIT_LONG_TRANS
#ifdef SPLIT_LONG_TRANS
#define STRIDE 4
#endif
