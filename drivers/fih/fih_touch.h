...
struct fih_touch_cb
{
    ...
    int (*touch_long_press_write)(unsigned int);
    unsigned int (*touch_long_press_read)(void);
    int (*touch_fp_en_write)(unsigned int);
    unsigned int (*touch_fp_en_read)(void);
    int (*touch_long_press_time_write)(unsigned int);
    unsigned int (*touch_long_press_time_read)(void);
    int (*touch_long_press_size_write)(unsigned int);
    unsigned int (*touch_long_press_size_read)(void);
};
