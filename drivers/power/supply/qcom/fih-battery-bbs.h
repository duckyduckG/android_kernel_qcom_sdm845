...
/* Error Code: 3/USB */
#define BBS_USB_FLOATING_CHARGING_MODE()\
do { printk("BBox::UEC;3::1;USB floating charging mode\n"); } while (0)
#define BSS_USB_POWER_SUPPLY_TYPE_UNKNOWN() \
do { printk("BBox::UEC;3::5;USB POWER_SUPPLY_TYPE_UNKNOWN\n"); } while (0)
